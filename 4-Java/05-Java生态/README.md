...
Java 企业级开发核心技术栈，涵盖 Spring 全家桶、持久化、消息队列、容器化和微服务等核心主题。

## 目录

- [01-Spring入门](./01-Spring入门.md) - Spring 框架核心概念：IoC、DI、AOP
- [02-SpringBoot深度](./02-SpringBoot深度.md) - Spring Boot 自动配置原理、Actuator 监控
- [03-JPA与Hibernate](./03-JPA与Hibernate.md) - JPA 规范与 Hibernate 实现
- [04-Redis](./04-Redis.md) - Redis 数据结构、Spring Data Redis 实战
- [05-Kafka](./05-Kafka.md) - Kafka 消息队列、Spring Kafka 集成
