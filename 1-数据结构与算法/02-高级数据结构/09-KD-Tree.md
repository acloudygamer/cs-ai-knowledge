...
<pre>
根 (7,2) dim0: d²=(6-7)²+(5-2)²=10 → best=(7,2); 6<7 进左
(5,4) dim1: d²=1+1=2<10 → 更新 best=(5,4); 5≥4 先进右 (4,7)
(4,7) dim0: d²=4+4=8 不更新; 叶, 回溯
回 (5,4): 跨域 dx²=(5-4)²=1<2 → 查左 (2,3): d²=20 不更新
回根: 跨域 dx²=(6-7)²=1<2 → 查右 (9,6): d²=10 不更新; 其左 (8,1): d²=20
最终: (5,4), 距离 √2
</pre>
