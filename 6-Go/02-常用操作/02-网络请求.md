...
func fastHTTPHandler(ctx *fasthttp.RequestCtx) {
    ...
    case "/ping":
        ...
        json.NewEncoder(ctx).Encode(map[string]string{"message": "pong"})
    case "/hello":
        name := string(ctx.UserValue("name").([]byte))
        ctx.SetContentType("application/json")
        json.NewEncoder(ctx).Encode(map[string]string{"message": "Hello " + name})
    default:
