...
Wrapper<int, MyVector> w;  // 模板的模板参数
```
...
using Types = TypeList<int, double, std::string>;
...
// C++17 std::index_sequence
template<size_t... Is>
constexpr std::index_sequence<Is...> make_index_sequence_impl(IndexSequence<Is...>) {
    return {};
}
```
...
constexpr auto arr = StaticArray<int, 5>{{1, 2, 3, 4, 5}};
